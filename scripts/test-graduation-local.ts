...
// Test constants
// Use a valid-looking EVM address with a timestamp suffix for uniqueness
const ts = Date.now().toString(16).padStart(12, '0').slice(0, 12);
const TEST_TOKEN = `0xTEST000000000000000000000000${ts}`.toLowerCase();
...
// Must be valid 20-byte EVM addresses (40 hex chars after 0x) for Merkle tree
const TEST_USERS = [
  { address: '0xAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA0001', tokens: '200000000000000000000000000' },
  { address: '0xBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB0002', tokens: '150000000000000000000000000' },
  { address: '0xCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC0003', tokens: '275000000000000000000000000' },
];
